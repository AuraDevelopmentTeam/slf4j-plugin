 ...
 * @author Peter Royal
 */
public final class BungeecordLoggerAdapter extends MarkerIgnoringBase
    implements LocationAwareLogger {
  private static final long serialVersionUID = 8583671528939800176L;

  private static final String SELF = BungeecordLoggerAdapter.class.getName();
  ...
  BungeecordLoggerAdapter(java.util.logging.Logger logger) {
    this.logger = logger;
